...
number_images = 100 #change to an input to be passed to function
img_edge_length = 100
#============================================================================#
def scrape_images_for_query(search_term, number_images):
    ...
    def persist_image(folder_path:str,url:str):
        ...
        try:
            ...
            file_path = os.path.join(folder_path, search_term + '_' + sha1(image_content).hexdigest()[:10] + '.jpg')
            with open(file_path, 'wb') as f:
                # FIND WAY TO PRESERVE ASPECT RATIO OF IMAGE, CROP TO MAX SQUARE (CENTERED) -Ry
                # -> THEN RESIZE
                image = image.resize((img_edge_length, img_edge_length), Image.ANTIALIAS)
...
scrape_images_for_query(search_term, number_images)